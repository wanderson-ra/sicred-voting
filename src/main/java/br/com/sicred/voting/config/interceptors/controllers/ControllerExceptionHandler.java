...
public class ControllerExceptionHandler {
	...
	private static final String SAO_CONSTRAINT_VIOLATION = "sicred.error.constraintViolation";
	...
	@ExceptionHandler({ SicredVotingBaseException.class})
	@ResponseBody
	public ResponseEntity<ExceptionJson> saoException(final SicredVotingBaseException e, final HttpServletResponse response) {
	...
	public ExceptionJson handleHttpMessageNotReadableException(final HttpMessageNotReadableException ex) {
		...
		if ( !ObjectUtils.isEmpty(ex.getMessage()) && ";".contains(ex.getMessage())) {
